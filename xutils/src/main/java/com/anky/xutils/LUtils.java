...
public final class LUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = UtilsManager.getApp()
                    .getPackageManager()
                    .getPackageInfo(UtilsManager.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && UtilsManager.getApp().getExternalCacheDir() != null)
                mDefaultDir = UtilsManager.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = UtilsManager.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
