...
public class XMenuLayout extends ViewGroup {
    ...
    private static XMenuLayout mViewCache;
    ...
    public XMenuLayout(Context context) {
        this(context, null);
    }

    public XMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public XMenuLayout setIos(boolean ios) {
        isIos = ios;
        return this;
    }
    ...
    public XMenuLayout setLeftSwipe(boolean leftSwipe) {
        isLeftSwipe = leftSwipe;
        return this;
    }


    public static XMenuLayout getViewCache() {
        return mViewCache;
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        isIos = true;
        isLeftSwipe = true;
        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, R.styleable.XMenuLayout, defStyleAttr, 0);
        int count = ta.getIndexCount();
        for (int i = 0; i < count; i++) {
            int attr = ta.getIndex(i);
            if (attr == R.styleable.XMenuLayout_xmenu_swipeEnable) {
                isSwipeEnable = ta.getBoolean(attr, true);
            } else if (attr == R.styleable.XMenuLayout_xmenu_ios) {
                isIos = ta.getBoolean(attr, true);
            } else if (attr == R.styleable.XMenuLayout_xmenu_leftSwipe) {
